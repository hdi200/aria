...
{
    NSData *imageData = [NSData dataWithBytes:page.pngData.data() length:page.pngData.size()];
...
MSRSelectionInfo * _Nullable MakeSelectionInfo(const msr::render::ScoreSelectionState& selectionState)
{
    ...
    NSData *overlayImageData = [NSData dataWithBytes:selectionState.overlayPngData.data()
                                              length:selectionState.overlayPngData.size()];
