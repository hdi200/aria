...
@interface MSRLayoutBreakMarker : NSObject
...
@property (nonatomic, copy, readonly) NSData *pdfData;
@property (nonatomic, copy, readonly) NSArray<MSRLayoutBreakMarker *> *layoutBreakMarkers;
...
- (instancetype)initWithPageIndex:(NSInteger)pageIndex
                ...
                layoutBreakMarkers:(NSArray<MSRLayoutBreakMarker *> *)layoutBreakMarkers NS_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly) NSInteger currentTimeSignatureNumerator;
@property (nonatomic, readonly) NSInteger currentTimeSignatureDenominator;
...
@property (nonatomic, readonly) BOOL isLayoutBreak;
@property (nonatomic, copy, readonly) NSString *layoutBreakType;
@property (nonatomic, readonly) BOOL isExpressionSpanner;
@property (nonatomic, readonly) BOOL isSlur;
@property (nonatomic, readonly) BOOL isTie;
...
@property (nonatomic, readonly) NSInteger overlayPixelHeight;
@property (nonatomic, copy, readonly) NSData *overlayImageData;
@property (nonatomic, copy, readonly) NSData *overlayPdfData;
              ...
              overlayNormalizedHeight:(double)overlayNormalizedHeight
                  ...
                  overlayPixelHeight:(NSInteger)overlayPixelHeight
                     overlayImageData:(NSData *)overlayImageData
                       overlayPdfData:(NSData *)overlayPdfData NS_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly) double pageWidthMillimeters;
@property (nonatomic, readonly) double pageHeightMillimeters;
@property (nonatomic, readonly) double pageMarginMillimeters;
@property (nonatomic, readonly) double staffSizeMillimeters;
@property (nonatomic, readonly) double staffSpacingSpatium;
@property (nonatomic, readonly) double systemSpacingSpatium;
...
- (instancetype)initWithSelection:(nullable MSRSelectionInfo *)selection
             ...
             pageMarginMillimeters:(double)pageMarginMillimeters
              ...
              systemSpacingSpatium:(double)systemSpacingSpatium NS_DESIGNATED_INITIALIZER;
...
- (nullable NSData *)pdfDataWithError:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(pdfData());
...
- (nullable MSREditState *)previewMeasureRangeAtPageIndex:(NSInteger)pageIndex
                                         startNormalizedX:(double)startNormalizedX
                                         startNormalizedY:(double)startNormalizedY
                                           endNormalizedX:(double)endNormalizedX
                                           endNormalizedY:(double)endNormalizedY
                                                    error:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(previewMeasureRange(pageIndex:startNormalizedX:startNormalizedY:endNormalizedX:endNormalizedY:));
...
- (nullable MSREditState *)selectAttachedChordTextWithError:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(selectAttachedChordText());
- (nullable MSREditState *)selectAttachedLyricsWithError:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(selectAttachedLyrics());
...
- (nullable MSREditState *)updatePageLayoutWithPageWidthMillimeters:(double)pageWidthMillimeters
                                           ...
                                           systemSpacingSpatium:(double)systemSpacingSpatium
                                                         error:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(updatePageLayout(pageWidthMillimeters:pageHeightMillimeters:marginMillimeters:staffSizeMillimeters:staffSpacingSpatium:systemSpacingSpatium:));
...
- (nullable MSREditState *)removeMIDIPitchFromCurrentChord:(NSInteger)midiPitch
                                                      error:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(removeMIDIPitchFromCurrentChord(_:));
...
- (nullable MSREditState *)changeSelectedEnharmonicSpellingWithError:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(changeSelectedEnharmonicSpelling());
- (nullable MSREditState *)changeSelectedAccidental:(NSInteger)accidentalKind
                                              error:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(changeSelectedAccidental(_:));
...
- (nullable MSREditState *)setInstrumentAtIndex:(NSInteger)partIndex
                                        visible:(BOOL)visible
                                          error:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(setInstrument(at:visible:));
